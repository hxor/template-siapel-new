			...
			<div class="content-page">
				...
				<div class="content">
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Urusan Bidang</h4>
								<ol class="breadcrumb">
									<li>
										<a href="#">Dashboard</a>
									</li>
							...
							<div class="col-lg-12">
								<div class="panel panel-color panel-inverse">
									<div class="panel-heading">
                                        ...
                                        <a href="urusan-bidang-form.php" class="btn btn-default pull-right" style="margin-top: 0px;">Add +</a>
                                        </h3>
									</div>
