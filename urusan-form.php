			...
			<div class="content-page">
				...
				<div class="content">
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Tambah Urusan</h4>
								<ol class="breadcrumb">
									<li>
										<a href="#">Urusan</a>
									</li>
							...
							<div class="col-lg-12">
								<div class="panel panel-color panel-inverse">
									<div class="panel-heading">
										<h3 class="panel-title">Tambah Urusan</h3>
									</div>
									<div class="panel-body">
                                        <form action="#" data-parsley-validate="" novalidate="">
                                            <div class="form-group">
                                                <label for="kode_urusan">Kode Urusan</label>
                                                <input type="text" name="kode_urusan" parsley-trigger="change" required="" placeholder="Input kode urusan" class="form-control" id="kode_urusan">
                                            </div>
                                            <div class="form-group">
